...
if( process.env.BONSAI_URL ) {
  ...
  exports.ES_HOST  = process.env.ES_HOST || 'elm-6282364.us-east-1.bonsaisearch.net';

  // ElasticSearch server's host port
  exports.ES_PORT  = process.env.ES_PORT || '80';

  // ElasticSearch username for http auth
  exports.ES_USER  = process.env.ES_USER || 'cvux4jcd';

  // ElasticSearch password for http auth
  exports.ES_PASS  = process.env.ES_PASS || 'l6psox96ceqa9kbj';
}
